...
function PublicProfile(props) {
    ...
    <Container>
        <Row id="profileBody">
        <Col xs={9}>
            {profile && <ProfileCard public img={profile.image} name={`${profile.name} ${profile.surname}`} about={profile.title} location={profile.area} profile={profile} refresh={props.refresh} />}
            {profile && <About bio={profile.bio} profile={profile} refresh={props.refresh} public />}
