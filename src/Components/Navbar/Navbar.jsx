    ...
    <>
          ...
          <div className="d-flex align-items-center w-100">
            ...
            <Form inline className="d-flex align-items-center w-100 position-relative">
              <FormControl
                ...
                value={searchValue}
                onChange={(e) => setSearchValue(e.target.value)}></FormControl>
              {searchValue && (
                <SearchField query={searchValue} reset={() => setSearchValue("")} />
              )}
            </Form>
          </div>
          <div>
            ...
            <Navbar.Collapse id="basic-navbar-nav" className="d-flex">
              <Nav className="nav-h6 d-flex">
                <NavLink
                  ...
                  <h6 className="mt-1 mb-0" style={{ fontSize: "12px" }}>
                    Home
                  </h6>
                </NavLink>
                <NavLink
                  to="/network"
                  activeClassName={styles.activeTab}
                  className={`${styles.navlink} d-none d-lg-flex`}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="21"
                    height="21"
                    ...
                    <path
                      fillRule="evenodd"
                      d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.323 6.323 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"
                    />
                ...
                <div className={styles.dropmenu}>
                  ...
                  <NavDropdown
                    ...
                    <Link to="/me" className={styles.btn}>
                      {" "}
                      <Button text="View Profile" className={styles.dropdownbutton}>
                        View Profile
                      </Button>
                    </Link>
                    <NavDropdown.Divider />
                    <NavDropdown.Item className={styles.accountfont}>
                      Account
                    </NavDropdown.Item>
                    <NavDropdown.Item className={styles.regularfont}>
                      Settings and Privacy
                    </NavDropdown.Item>
                    <NavDropdown.Item className={`${styles.regularfont} mt-2  `}>
                      Help
                    </NavDropdown.Item>
                    <NavDropdown.Item className={`${styles.regularfont} mt-2  `}>
                      Language
                    ...
                    <NavDropdown.Divider />
                    <NavDropdown.Item
                      className={`${styles.regularfont} mt-2  `}
                ...
                <Nav.Link
                  href="#link"
                  className={`${styles.navlink} flex-row ${styles.premium} d-none d-xl-flex`}>
      ...
      <Navbar
        ...
        className={`${styles.subNav} ${
          navbar ? styles.navbarScrollactive : styles.navbarScroll
        }`}>
        <Container>
          <Form inline className={styles.scrollNav}>
            <Navbar.Brand href="#home" className="m-0 mr-2">
              <img src={props.profile?.image} className={styles.scrollNavImg} alt="" />
            </Navbar.Brand>
            <div href="#link" className={styles.navname}>
              <h6 className={styles.scrollNavText}>
                {props.profile?.name} {props.profile?.surname}
              </h6>
              <h6 className=" mb-0" style={{ fontSize: "12px", fontWeight: "400" }}>
                {props.profile?.title}
              </h6>
            </div>
          </Form>
