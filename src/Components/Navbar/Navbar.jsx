...
function NavBar (){
    ...
    return(
        ...
        <div >
         ...
         <Form inline>
            <Navbar.Brand href="#home"><img src={logo} style= {{ width:'38px',height:'38px', borderRadius:'5px'}}/></Navbar.Brand>
        ...
        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
            ...
            <FormControl type="text" bg="" placeholder="Search" className={ styles.searchbar} >
        ...
        <h6 className="mt-1 mb-0" style={{fontSize:'12px'}} >Notifications</h6>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-grid-3x3-gap-fill" viewBox="0 0 16 16">
        ...
        <Navbar.Brand href="#home" className="m-0 mr-2"><img src={pp} className={styles.scrollNavImg}/></Navbar.Brand>  
