...
import { postExp, putExp, addExpImage } from "../../../Lib/fetch"
          ...
          <div className="mt-3 mb-3 d-flex" style={{ justifyContent: "space-evenly" }}>
            <div>
              ...
              {!experience.startDate && (
                <p className={`${styles.invalid} mt-1`}>Please enter a start date.</p>
              )}
            </div>
            <div className="ml-5">
              ...
              {!experience.endDate && !checked && (
                <p className={`${styles.invalid} mt-1`}>Please enter an end date.</p>
              )}
            </div>
          </div>
